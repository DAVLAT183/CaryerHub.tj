      ...
      <div className="w-full max-w-md">
        <div className="card p-6 sm:p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="font-heading font-bold text-2xl mb-1.5 text-text-primary">{t('auth.welcomeBack')}</h1>
            <p className="text-sm text-text-muted">{t('auth.welcomeBackDesc')}</p>
          </div>
          ...
          <div className="mt-4 p-4 rounded-xl border border-yellow-500/30 bg-yellow-500/5">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm text-yellow-400 font-medium">{t('auth.emailNotVerified')}</p>
                <p className="text-xs text-text-muted mt-1">
                  {t('auth.checkEmail', { email: user.email })}
                </p>
                {resendSuccess ? (
                  <div className="flex items-center gap-2 mt-2">
                    <CheckCircle size={14} className="text-accent-primary" />
                    <span className="text-xs text-accent-primary">{t('auth.letterSent')}</span>
                  </div>
                ) : (
                  <Button
